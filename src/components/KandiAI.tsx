...
const KandiAI: React.FC<KandiAIProps> = ({ username }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: `Hi ${username}! I'm Kandi, your AI companion. I can help you find compatible matches based on your cultural interests and preferences. What would you like to explore today?`,
      isUser: false,
      timestamp: new Date()
    }
  ]);
          ...
          <div className="border-t p-4">
            <div className="flex space-x-2">
              <Input
                ...
                placeholder="Ask Kandi anything about cultural connections..."
