...
const EnhancedPreferencesScreen: React.FC<Props> = ({ username, onComplete, onSkip }) => {
  ...
  const renderStep = (stepNum: number, title: string, subtitle: string, content: React.ReactNode) => (
    <ScrollArea className="h-[65vh] pr-4">
      <div className="space-y-6">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold bg-gradient-to-r from-teal-600 via-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
            {title}
          </h2>
  ...
  const steps = [
    () => renderStep(1, "Cultural Background", "Tell us about your cultural identity", (
    ...
    () => renderStep(2, "Interests & Passions", "What excites you most?", (
    ...
    () => renderStep(3, "Lifestyle Preferences", "How do you live your life?", (
      <div className="space-y-6">
    ...
    () => renderStep(4, "Social & Travel Style", "How do you connect and explore?", (
      <div className="space-y-6">
